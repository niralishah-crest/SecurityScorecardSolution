"""This file has class and methods to push issue data into azure sentinel."""
import os
import datetime
import json
import logging
...
class CompanyWriter(object):
    ...
    def write_issues(self, portfolio_id=None, **config):
        """write_issues method will process the overall Score for a company."""
        chk_point_name = ""
        try:
