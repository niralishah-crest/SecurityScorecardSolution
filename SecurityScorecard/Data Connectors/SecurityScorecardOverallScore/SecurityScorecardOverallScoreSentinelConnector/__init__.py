...
LEVEL_OVERALL_CHANGE = os.environ["LEVEL_OVERALL_CHANGE"]
PORTFOLIO_IDS_STR = os.environ["PORTFOLIO_IDS_STR"]
DIFF_OVERRIDE_OWN_OVERALL = os.environ["DIFF_OVERRIDE_OWN_OVERALL"]
DIFF_OVERRIDE_PORTFOLIO_OVERALL = os.environ["DIFF_OVERRIDE_PORTFOLIO_OVERALL"]
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    try:
        ...
        if check_date != str(to_date):
            # Fetching data of domain OverallScore and writing it into the Azure Sentinel
            scorecard_obj = ScoreCardHelperClass(base_url, secret_key, domain)
            writer_obj = CompanyWriter(scorecard_obj, state_manager_object)
            logging.info(
                "SecurityScorecard Connector: Writting Overall data into the Azure Sentinel!"
            )
        ...
        # Fetching data of portfolio companies and writing it into the Azure Sentinel
